...
{
    public class BookIndexerWithTextEmbedding3Small : IBookIndexer
    {
        ...
        public BookIndexerWithTextEmbedding3Small(QdrantClient qdrantClient, 
        ...
        public async Task IndexBooksAsync(string filePath, int batchSize = 50)
        {
            ...
            foreach (BookRecord book in books)
            {
                ...
                {
                    var embedding = await _embeddingService.GenerateEmbeddingAsync(chunk.FullContext);
